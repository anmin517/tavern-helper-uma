...
{ name: '曼城茶座', tag: '神秘少女', personality: '追逐无形身影的神秘少女，安静而执着', goal: '追上那个永远跑在前面的「朋友」', stats: { 速度: 83, 耐力: 98, 力量: 94, 毅力: 86, 智慧: 89 }, apt: { '草地': 'A', '泥地': 'G', '短距离': 'G', '英里': 'F', '中距离': 'B', '长距离': 'F', '逃': 'G', '先行': 'C', '差': 'A', '追': 'C' }, skills: ['御宅族', '下雨天○', '消声器', '小休息'] , unique: '紧紧追着你（アナタヲ・オイカケテ）' },
  { name: '富士奇迹', tag: '绅士护卫', personality: '护卫就交给我吧！ 华丽又绅士的少女。', goal: '守护大家的奔跑', stats: { 速度: 117, 耐力: 107, 力量: 118, 毅力: 100, 智慧: 108 }, apt: { '草地': 'A', '泥地': 'F', '短距离': 'B', '英里': 'A', '中距离': 'B', '长距离': 'E', '逃': 'C', '先行': 'A', '差': 'C', '追': 'G' }, skills: ['好位追走', '诡计（前）', '不服输'] , unique: '闪耀煌星的演剧' },
  { name: '大和赤骥', tag: '唯我独尊', personality: '唯我独尊！ 好强的傲娇少女。', goal: '成为最强的自己', stats: { 速度: 109, 耐力: 99, 力量: 103, 毅力: 122, 智慧: 117 }, apt: { '草地': 'A', '泥地': 'G', '短距离': 'F', '英里': 'A', '中距离': 'A', '长距离': 'B', '逃': 'A', '先行': 'A', '差': 'E', '追': 'G' }, skills: ['对抗意识○', '好位追走', '加快节奏'] , unique: '闪耀的赤色王牌 Brilliant red ace' },
  { name: '草上飞', tag: '大和抚子', personality: '楚楚可怜。 美国归国的大和抚子。', goal: '以优雅的奔跑闪耀', stats: { 速度: 118, 耐力: 91, 力量: 129, 毅力: 96, 智慧: 116 }, apt: { '草地': 'A', '泥地': 'G', '短距离': 'G', '英里': 'A', '中距离': 'B', '长距离': 'A', '逃': 'F', '先行': 'A', '差': 'A', '追': 'F' }, skills: ['超越姿态', '先行焦躁', '束缚'] , unique: '精神一到、何事不成' },
  { name: '菱亚马逊', tag: '大姐头', personality: '要单挑的话正合我意！ 大家伙们值得信赖的大姐头舍长。', goal: '堂堂正正的单挑胜利', stats: { 速度: 113, 耐力: 103, 力量: 129, 毅力: 100, 智慧: 105 }, apt: { '草地': 'A', '泥地': 'G', '短距离': 'D', '英里': 'A', '中距离': 'A', '长距离': 'B', '逃': 'G', '先行': 'B', '差': 'C', '追': 'A' }, skills: [] , unique: '单挑！白热化！' },
  { name: '爱丽数码', tag: '超级宅女', personality: '最喜欢赛马娘了！ 超级万能的宅女。', goal: '为所有赛马娘应援', stats: { 速度: 101, 耐力: 111, 力量: 101, 毅力: 122, 智慧: 112 }, apt: { '草地': 'A', '泥地': 'A', '短距离': 'F', '英里': 'A', '中距离': 'A', '长距离': 'G', '逃': 'G', '先行': 'A', '差': 'A', '追': 'B' }, skills: ['差行直线○', '喜欢马娘', '前行'] , unique: '尊之☆最终冲刺—(ﾟ∀ﾟ)—ﾄ!' },
  { name: '琵琶晨光', tag: '知性派', personality: '热情的知性派。 以逻辑为武器！', goal: '以逻辑迈向顶点', stats: { 速度: 104, 耐力: 114, 力量: 101, 毅力: 114, 智慧: 117 }, apt: { '草地': 'A', '泥地': 'F', '短距离': 'F', '英里': 'C', '中距离': 'A', '长距离': 'A', '逃': 'E', '先行': 'A', '差': 'B', '追': 'E' }, skills: ['路况不佳○', '深呼吸', '保持体力'] , unique: '∴win Q.E.D.' },
  { name: '摩耶重炮', tag: '天真少女', personality: '天真的少女。 想快点长大！', goal: '快点长大、全力奔跑', stats: { 速度: 94, 耐力: 130, 力量: 86, 毅力: 123, 智慧: 117 }, apt: { '草地': 'A', '泥地': 'E', '短距离': 'D', '英里': 'D', '中距离': 'A', '长距离': 'A', '逃': 'A', '先行': 'A', '差': 'B', '追': 'B' }, skills: ['直线回复', '深呼吸', '领者的自尊心'] , unique: '闪光☆着陆' },
  { name: '目白赖恩', tag: '运动少女', personality: '运动让人心情舒爽！ 闪耀的汗水也很纯净。', goal: '闪耀汗水地奔跑', stats: { 速度: 120, 耐力: 91, 力量: 130, 毅力: 98, 智慧: 111 }, apt: { '草地': 'A', '泥地': 'G', '短距离': 'E', '英里': 'C', '中距离': 'A', '长距离': 'B', '逃': 'F', '先行': 'A', '差': 'A', '追': 'F' }, skills: ['雨天○', '外道超车准备', '加快节奏'] , unique: '成长吧我的肌肉！' },
  { name: '菱曙', tag: '开朗巨体', personality: '很巨大！很开朗！大……盘子？ 请吃料理吧♪', goal: '用大爆发力取胜', stats: { 速度: 120, 耐力: 74, 力量: 132, 毅力: 111, 智慧: 113 }, apt: { '草地': 'A', '泥地': 'F', '短距离': 'A', '英里': 'B', '中距离': 'F', '长距离': 'G', '逃': 'B', '先行': 'A', '差': 'C', '追': 'G' }, skills: ['晴天○', '着手准备', '营养补给'] , unique: '全速☆前进!!' },
  { name: '爱丽速子', tag: '疯狂科学家', personality: '禁断的疯狂科学家。 肉体研究才是一切！', goal: '用肉体研究证明一切', stats: { 速度: 112, 耐力: 104, 力量: 104, 毅力: 108, 智慧: 122 }, apt: { '草地': 'A', '泥地': 'G', '短距离': 'G', '英里': 'D', '中距离': 'A', '长距离': 'B', '逃': 'E', '先行': 'A', '差': 'B', '追': 'F' }, skills: ['根干距离○', '好位追走', '束缚'] , unique: 'U=ma2' },
  { name: '胜利奖券', tag: '感情全开', personality: '尽情地笑着哭吧！ 感情全开的正直少女。', goal: '笑着哭、跑着赢', stats: { 速度: 120, 耐力: 93, 力量: 125, 毅力: 101, 智慧: 111 }, apt: { '草地': 'A', '泥地': 'G', '短距离': 'G', '英里': 'F', '中距离': 'A', '长距离': 'B', '逃': 'G', '先行': 'B', '差': 'A', '追': 'G' }, skills: ['好马场○', '誓不罢休', '努力之人'] , unique: '为你奉上，胜利奖券！' },
  { name: '荣进闪耀', tag: '严谨计划者', personality: '一切都按照计划进行。 严谨耿直的少女。', goal: '一切按照计划取胜', stats: { 速度: 122, 耐力: 101, 力量: 113, 毅力: 100, 智慧: 114 }, apt: { '草地': 'A', '泥地': 'G', '短距离': 'G', '英里': 'F', '中距离': 'A', '长距离': 'A', '逃': 'G', '先行': 'B', '差': 'A', '追': 'C' }, skills: ['随机应变', '中距离弯道○', '差行的诀窍○'] , unique: '漆黑之剑' },
  { name: '真机伶', tag: '可爱闪光', personality: '卡哇伊的闪光奔跑！ 请多多爱着我哦♪', goal: '让大家都爱着我', stats: { 速度: 119, 耐力: 71, 力量: 130, 毅力: 111, 智慧: 119 }, apt: { '草地': 'A', '泥地': 'F', '短距离': 'A', '英里': 'D', '中距离': 'G', '长距离': 'G', '逃': 'B', '先行': 'A', '差': 'E', '追': 'G' }, skills: ['加快步伐', '钉死后方', '干扰'] , unique: '＃LookatCurren' },
  { name: '川上公主', tag: '豪爽假小子', personality: '目标是公主！ 豪爽的假小子赛马娘。', goal: '以公主之名取胜', stats: { 速度: 122, 耐力: 87, 力量: 131, 毅力: 101, 智慧: 109 }, apt: { '草地': 'A', '泥地': 'G', '短距离': 'D', '英里': 'B', '中距离': 'A', '长距离': 'F', '逃': 'G', '先行': 'C', '差': 'A', '追': 'D' }, skills: ['回避力竭马', '外道超车准备', '不服输'] , unique: '以姬之名，手握胜利' },
  { name: '黄金城', tag: '毒舌辣妹', personality: '出言不逊的极品・辣妹', goal: '用实力碾压一切', stats: { 速度: 109, 耐力: 113, 力量: 114, 毅力: 112, 智慧: 102 }, apt: { '草地': 'A', '泥地': 'D', '短距离': 'F', '英里': 'A', '中距离': 'B', '长距离': 'B', '逃': 'F', '先行': 'A', '差': 'A', '追': 'F' }, skills: ['阪神竞马场○', '超越姿态', '窥视展开'] , unique: 'KEEP IT REAL.' },
  { name: '樱花进王', tag: '爆进班长', personality: '大暴走(？)的班长。 无论何时都要爆进！', goal: '无论何时都要爆进', stats: { 速度: 120, 耐力: 74, 力量: 128, 毅力: 116, 智慧: 112 }, apt: { '草地': 'A', '泥地': 'G', '短距离': 'A', '英里': 'B', '中距离': 'G', '长距离': 'G', '逃': 'A', '先行': 'A', '差': 'F', '追': 'G' }, skills: ['短距齿轮', '逃马焦躁', '先行直线○'] , unique: '优等生×爆进=大胜利' },
  { name: '超级小海湾', tag: '温柔大姐姐', personality: '用温和母性治愈别人的温柔大姐姐。', goal: '用母性治愈大家', stats: { 速度: 84, 耐力: 129, 力量: 92, 毅力: 129, 智慧: 116 }, apt: { '草地': 'A', '泥地': 'G', '短距离': 'G', '英里': 'G', '中距离': 'A', '长距离': 'A', '逃': 'D', '先行': 'A', '差': 'B', '追': 'G' }, skills: ['弯道回复○', '深呼吸', '干扰'] , unique: '纯洁之心' },
  { name: '成田大进', tag: '冷酷小个子', personality: '冷酷又淡漠！ 用娇小的身体赢得胜利。', goal: '用娇小身体赢得胜利', stats: { 速度: 118, 耐力: 100, 力量: 121, 毅力: 97, 智慧: 114 }, apt: { '草地': 'A', '泥地': 'G', '短距离': 'F', '英里': 'D', '中距离': 'A', '长距离': 'A', '逃': 'G', '先行': 'F', '差': 'B', '追': 'A' }, skills: ['后方待机', '细语', '孤狼'] , unique: 'Nemesis 复仇女神' },
  { name: '待兼福来', tag: '福运祈愿', personality: '福气来吧！ 热爱占卜的福运祈愿少女', goal: '带来福气地奔跑', stats: { 速度: 106, 耐力: 111, 力量: 121, 毅力: 111, 智慧: 101 }, apt: { '草地': 'A', '泥地': 'F', '短距离': 'F', '英里': 'C', '中距离': 'A', '长距离': 'A', '逃': 'G', '先行': 'B', '差': 'A', '追': 'F' }, skills: ['障眼法', '小休息', '幸运7'] , unique: '禾乃登(处暑三候禾乃登)' },
  { name: '名将怒涛', tag: '消极努力家', personality: '想要变得积极！ 消极但努力的姑娘。', goal: '变得积极、永不放弃', stats: { 速度: 113, 耐力: 116, 力量: 104, 毅力: 118, 智慧: 99 }, apt: { '草地': 'A', '泥地': 'E', '短距离': 'G', '英里': 'F', '中距离': 'A', '长距离': 'A', '逃': 'F', '先行': 'A', '差': 'B', '追': 'E' }, skills: ['保持步伐', '准备突围', '中距离弯道○'] , unique: '永不言败' },
  { name: '优秀素质', tag: '尖锐评论家', personality: '拒绝被给予期待？ 观点尖锐的少女。', goal: '拒绝被给予期待地奔跑', stats: { 速度: 118, 耐力: 99, 力量: 123, 毅力: 96, 智慧: 114 }, apt: { '草地': 'A', '泥地': 'G', '短距离': 'G', '英里': 'C', '中距离': 'A', '长距离': 'A', '逃': 'F', '先行': 'B', '差': 'A', '追': 'D' }, skills: ['小仓竞马场○', '细语', '锐利目光'] , unique: '一定就在前方…！' },
  { name: '帝王光辉', tag: '高傲大小姐', personality: '高傲的大小姐。 其自尊心比天空还高！', goal: '比天空还高的自尊取胜', stats: { 速度: 120, 耐力: 82, 力量: 127, 毅力: 100, 智慧: 121 }, apt: { '草地': 'A', '泥地': 'G', '短距离': 'A', '英里': 'B', '中距离': 'B', '长距离': 'C', '逃': 'G', '先行': 'B', '差': 'A', '追': 'D' }, skills: ['擅长外枠○', '紧追不舍', '阅读能力'] , unique: '帝王之傲' },
];
...
入学手续完成。请训练员安排我的第一周训练——先从基础的速度训练开始，还是先做体能摸底？`;
});
...
function sendNarrative() {
  ...
  try {
    ...
    // 角色创建完成 → 进入养成阶段（否则 AI 仍按开局选择分支引导，卡住不进下一阶段）
    store.data.系统.当前阶段 = '养成';
